...
const getSortBy = (param: unknown): 'title' | 'author' | 'rating' | 'reviews' | undefined => {
  const str = getQueryString(param);
...
export class BookController {
  ...
  static addBookmark(req: AuthRequest, res: Response) {
    return res.status(501).json(ApiResponseUtil.error('Method not implemented'));
  }

  static removeBookmark(req: AuthRequest, res: Response) {
    return res.status(501).json(ApiResponseUtil.error('Method not implemented'));
  }

  static getUserBookmarks(req: AuthRequest, res: Response) {
    return res.status(501).json(ApiResponseUtil.error('Method not implemented'));
  }

  static addFavorite(req: AuthRequest, res: Response) {
    return res.status(501).json(ApiResponseUtil.error('Method not implemented'));
  }

  static removeFavorite(req: AuthRequest, res: Response) {
    return res.status(501).json(ApiResponseUtil.error('Method not implemented'));
  }

  static getUserFavorites(req: AuthRequest, res: Response) {
    return res.status(501).json(ApiResponseUtil.error('Method not implemented'));
  }

  static getUserReadingList(req: AuthRequest, res: Response) {
    return res.status(501).json(ApiResponseUtil.error('Method not implemented'));
  }

  static removeFromReadingList(req: AuthRequest, res: Response) {
    return res.status(501).json(ApiResponseUtil.error('Method not implemented'));
  }

  static updateReadingStatus(req: AuthRequest, res: Response) {
    return res.status(501).json(ApiResponseUtil.error('Method not implemented'));
  }

  static addToReadingList(req: AuthRequest, res: Response) {
    return res.status(501).json(ApiResponseUtil.error('Method not implemented'));
  }
  ...
  static async getAllBooks(req: Request, res: Response) {
    try {
      ...
      return res.status(error.statusCode || 500).json(
        ApiResponseUtil.error(error.message || 'Failed to get books')
      );
    }
  }
   ...
   * Get popular books
   */
  static async getPopularBooks(req: Request, res: Response) {
    try {
      ...
      return res.status(500).json(
        ApiResponseUtil.error(error.message || 'Failed to get popular books')
      );
    }
  }
  ...
  static async getBooksByAuthor(req: Request, res: Response) {
    try {
      ...
      return res.status(500).json(
        ApiResponseUtil.error(error.message || 'Failed to get books by author')
      );
    }
  }
  ...
  static async getBookStats(req: Request, res: Response) {
    try {
      ...
      return res.status(500).json(
        ApiResponseUtil.error(error.message || 'Failed to get book statistics')
      );
    }
  }
   ...
   */
  static async getBookWithReviewSummary(req: Request, res: Response) {
    try {
      const idParam = getRouteParam(req.params.id);
      const bookId = parseInt(idParam || '', 10);
      ...
      return res.status(error.statusCode || 500).json(
        ApiResponseUtil.error(error.message || 'Failed to get book summary')
      );
    }
  }
  ...
  static async createBook(req: AuthRequest, res: Response) {
    try {
      ...
      if (!title || !author || !categoryId) {
        return res.status(400).json(
          ApiResponseUtil.badRequest('Title, author and category are required')
        );
      }
      ...
      return res.status(201).json(
        ApiResponseUtil.created(book, 'Book created successfully')
      );
    } catch (error: any) {
      console.error('❌ Error in createBook:', error);
      return res.status(error.statusCode || 500).json(
        ApiResponseUtil.error(error.message || 'Failed to create book')
      );
    }
  }
  ...
  static async updateBook(req: AuthRequest, res: Response) {
    try {
      ...
      if (req.body.publishDate !== undefined) updates.publish_date = req.body.publishDate;
      if (req.body.pages !== undefined) updates.pages = req.body.pages;
      ...
      return res.status(error.statusCode || 500).json(
        ApiResponseUtil.error(error.message || 'Failed to update book')
      );
    }
  }
  ...
  static async deleteBook(req: AuthRequest, res: Response) {
    try {
      ...
      return res.status(error.statusCode || 500).json(
        ApiResponseUtil.error(error.message || 'Failed to delete book')
      );
    }
  }
   ...
   */
  static async bulkCreateBooks(req: AuthRequest, res: Response) {
    try {
      const { books } = req.body;

      if (!books || !Array.isArray(books) || books.length === 0) {
        return res.status(400).json(
          ApiResponseUtil.badRequest('Books array is required')
        );
      }
      ...
      return res.status(error.statusCode || 500).json(
        ApiResponseUtil.error(error.message || 'Failed to bulk create books')
      );
    }
  }
}